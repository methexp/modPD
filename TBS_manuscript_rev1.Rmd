...
shorttitle        : "Two Button Sets Procedure"
author: 
...
The results of these tasks are not reported in the present paper (as it primarily focuses on the validation of the TBS task); procedural details and results will be reported in an online appendix (osf.io/xxxxx).]
...
Robust EC effects were found for memory attributions; the evidence for or against EC effects was inconclusive for "intuition" attributions; and EC effects were clearly absent for random-guessing/no-memory attributions.
This pattern of results is in line with those of Experiments 1 and 2, which also found an EC effect only for "remember" but not for "don't remember" attributions.
...
Thus, CS evaluations did not distort subjective decisions about recollection US valence or not. 
