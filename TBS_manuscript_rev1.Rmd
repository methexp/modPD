...
In addition to this validation part, we used the TBS procedure to provide preliminary information on the retrieval awareness question (i.e., can evaluative conditioning effects be observed in the absence of conscious US Valence memory?) and whether attitudes contaminate memory measures (i.e., affect-as-information bias).
...
The present research introduced a new measurement procedure - the TBS task - for advancing the study of (potential) EC effects in the absence of retrieval awareness. 
In the empirical section, we validated this new task and we additionaly used it to deliver preliminary insights into the influence of attitude-as-information biases typically found in retrieval-awareness studies, and insights relevant to the question of whether EC effects are found in the absence of feelings of US valence recollection. 
...
Finally, that a memory-independent parameter has been found in instruction-based procedures [@hutter_examining_2017] further challenges an associative interpretation of the findings [for related demonstrations, see also Béna, Mauclet, & Corneille, 2022; @corneille_evidence_2019].
...
We also illustrated how the measurement rationale underlying the TBR procedure may be adapted to address outstanding research questions of contemporary interest.
