...
(ref:task-displays) Screen displays of the per-item valence-memory task (left), the process-dissociation task (center), and the TBS task (right).
...
We recruited participants until there were at least 180 participants who had passed the instruction-understanding checks (see also below). 
...
This resulted in a final sample size of 185 participants.
