...
The valence-memory task was then expanded to also include a third, "I don't know", option that allowed participants to report their lack of memory and avoided the need to resort to heuristics (i.e., the *unforced choice valence-memory task*, or UCVM task).
...
Importantly, however, the 'remember' decision remains unobservable (see Figure xy). 
...
For instance, observable mnemonic decisions at the item level can help to empirically assess the accuracy of participants' metacognitive judgments (i.e., the proportion of "remember" cases in which correct US valence memory was indeed present).
