...
When participants made a feeling/intuition attribution, the EC effect was also significant, `r apa_print(mod_intuition_3bs_3ace_ratings)$full_result`, and the BF yielded evidence for an EC effect, `r printBFRR(bf_ev_intuition_3bs_3ace_ratings)`. 
