...
As a manipulation check, we first tested whether there was an EC effect overall (regardless of the specific task condition), based on the final total sample (*N =* `r length(unique(dat$subject))`). We computed pre-post evaluative change scores and tested whether they were influenced by US Valence (see Figure \@ref(fig:plot_eval_change)). 
