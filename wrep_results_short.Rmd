...
To analyze evaluations participants made in the TBS task, we additionally conducted a mixed-effect logistic regression (random intercepts and slopes for US Valence) with US Valence and Response buttons set as predictors. 
...
When participants used the memory response buttons set, the EC effect was significant, `r apa_print(mixedmod_val_mem)$full_result$us_valence1`. 
