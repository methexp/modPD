...
^[Again, this held even for small effects of, on average, 6 points on the 400-point rating scale. The data are inconclusive with regard to even smaller effects.]
...
^[Here, the data yield evidence against effects smaller than 15 points on the 400-point rating scale; they are inconclusive with regard to smaller effects.]
...
Importantly, we were interested in whether we find an EC effect when participants reported no memory (random guessing), as in the VMA task. 
