...
As in Experiment 2, a Bayesian analysis yielded evidence for no EC effect in the absence of memory, `r printBFRR(bf_prop_tbs_att)` (note that this conclusion again holds even for small effects).
