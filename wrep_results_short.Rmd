...
Next, we turn to the results of the TBS task, focusing on whether the absence of EC without remembering US valence is replicated when using a simplified design. 
...
As in Experiment 2, a Bayesian analysis yielded evidence for no EC effect in the absence of remembering US valence, `r printBFRR(bf_prop_tbs_att)` (note that this conclusion again holds even for small effects).
