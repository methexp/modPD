...
### Is evaluative conditioning observed when CS-US pairings are not remembered?
...
Importantly, replicating the absence of an EC effect in the absence of remembering US valence, US Valence did not affect these judgments, `r  apa_print(x2pA)$full_result$US_Valence_L`.
<!-- (z=.13, p=.9). -->
