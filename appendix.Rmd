...
kbl(table_vma_3ace, booktabs=TRUE, align="c", caption="Mean proportions (and SD) of attributions and of valence memory accuracy (with tests against the chance level) in the Valence Memory with Attributions (VMA) and the Three-attribution, continuous evaluation (3ACE) tasks (Experiment 3).", label="a2-vma-3ace", col.names = c("Task/ Attribution", "Proportion of responses", "Valence memory accuracy", "t test", "Cohen's d (95% CI)", "BF(H1) (Robustness Region)")) %>%
